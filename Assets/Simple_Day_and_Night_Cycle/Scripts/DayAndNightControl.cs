...
public class DayAndNightControl : MonoBehaviour
{
    ...
    void UpdateLight()
    {
        ...
        directionalLight.transform.localRotation = Quaternion.Euler((currentTime * 15f) - 90, 170, 0);
        moonState.transform.localRotation = Quaternion.Euler((currentTime * 15f) - 100, 170, 0);
        ...
        if (currentTime > 8f && currentTime < 17f)
        {
    ...
    public string TimeOfDay()
    {
        ...
        if (currentTime < 5f && currentTime > 1f)
        {
            dayState = "Morning";
        ...
        if (currentTime > 17f && currentTime < 19f)
        {
            dayState = "Evening";

        }
        if (currentTime > 19f && currentTime < 24f)
        {
            dayState = "Night";
        }
        return dayState;
    ...
    void OnGUI()
    {
        ...
        if (showUI)
        {
            ...
            GUILayout.VerticalSlider(currentTime, 0f, 24f);
        }
    }
}
