...
public class CameraRotate : MonoBehaviour
{
    ...
    public float maxOverAngle = 60;
    public float maxUnderAngle = -70;
    ...
    void LateUpdate()
    {
        ...
        Vector3 position = CameraArm.position - (rotation * Vector3.forward * desireDistance);
        ...
        if (Input.GetMouseButton(1))
        {
            ...
            CameraArm.eulerAngles = new Vector3(cameraX, transform.eulerAngles.y, transform.eulerAngles.z);
        }
